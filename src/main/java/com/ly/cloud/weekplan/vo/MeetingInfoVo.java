...
public class MeetingInfoVo{
	...
	public String getCyzsf() {
		return cyzsf;
	}

	public void setCyzsf(String cyzsf) {
		this.cyzsf = cyzsf;
	}
	...
	public String getSfyqd() {
		return sfyqd;
	}

	public void setSfyqd(String sfyqd) {
		this.sfyqd = sfyqd;
	}
